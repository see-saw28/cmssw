...
run2_egamma.toModify(
    ...
    Scale                       = cms.InputTag("calibratedPatPhotonsNano","scaleValue"),
    Smear                       = cms.InputTag("calibratedPatPhotonsNano","sigmaValue"),
    SmearUp                     = cms.InputTag("calibratedPatPhotonsNano","sigmaUpValue"),
    SmearDown                   = cms.InputTag("calibratedPatPhotonsNano","sigmaDownValue"),
    ScaleUp                     = cms.InputTag("calibratedPatPhotonsNano","scaleUpValue"),
    ScaleDown                   = cms.InputTag("calibratedPatPhotonsNano","scaleDownValue"),
    smearNrSigma                = cms.InputTag("calibratedPatPhotonsNano","smearNrSigma"),
...
photonTable = simplePATPhotonFlatTableProducer.clone(
    ...
    variables = cms.PSet(P3Vars,
        ...
        trkSumPtSolidConeDR04 = Var("trkSumPtSolidConeDR04()",float,doc="Sum of track pT in a cone of dR=0.4", precision=10),
        ecalPFClusterIso = Var("ecalPFClusterIso()",float,doc="sum pt of ecal clusters, vetoing clusters part of photon", precision=10),
        hcalPFClusterIso = Var("hcalPFClusterIso()",float,doc="sum pt of hcal clusters, vetoing clusters part of photon", precision=10), 
        pfPhoIso03 = Var("photonIso()",float,doc="PF absolute isolation dR=0.3, photon component (uncorrected)"),
        pfChargedIso = Var("chargedHadronIso()",float,doc="PF absolute isolation dR=0.3, charged component with dxy,dz match to PV", precision=10),        
        ...
        hoe = Var("hadronicOverEm()",float,doc="H over E",precision=10),
